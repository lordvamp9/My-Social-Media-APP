...
export default function Sidebar() {
  const { myId, username, myPfp, isHost, users, logout, addToast } = useStore();
  ...
  return (
    <div className="w-64 flex flex-col bg-msn-sidebar border-r border-msn-border shadow-msn z-10">
      ...
      <div className="p-4 msn-gradient border-b border-msn-border text-white shadow-md">
        ...
        {isHost && (
          <div
            className="text-xs bg-black/20 rounded p-2 flex items-center justify-between cursor-pointer hover:bg-black/30"
            onClick={copyId}
