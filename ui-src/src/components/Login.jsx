...
export default function Login() {
  ...
  const handleConnect = () => {
    if (!name.trim()) return alert('El apodo es requerido');
    if (!isHost && !roomId.trim()) return alert('El ID de la sala es requerido');
    ...
    initPeer(isHost, roomId.trim());
  };

  return (
    <div className="glass-card w-[350px] p-6 rounded-2xl flex flex-col items-center">
      <img 
        src="/logo.png" 
        alt="MSN Logo" 
